 ...
 * The source HTML ships with the real DXFCU-A-NR-601 readings *and* the
...
const SOURCE = resolve(process.cwd(), "spec/DXFCU_Air_Balancing_Form.html");
...
describe("DX FCU Air Balancing — parity with the source form", () => {
